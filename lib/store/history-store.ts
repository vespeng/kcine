...
export const useHistoryStore = createHistoryStore(profiledKey('kcine-history-store'));
export const usePremiumHistoryStore = createHistoryStore(profiledKey('kcine-premium-history-store'));
